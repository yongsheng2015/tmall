		...
		<div class="panel-body">
			<form method="post" id="addForm" action="admin_product_add">
				<table class="addTable">
					...
					<tr>
						<td>原价格</td>
						<td><input id="orignalPrice" name="orignalPrice" type="text" class="form-control" value="99.98"></td>
					</tr>
					<tr>
						<td>优惠价格</td>
						<td><input id="promotePrice" name="promotePrice" type="text" class="form-control" value="19.98"></td>
					</tr>
					<tr>
						<td>库存</td>
						<td><input id="stock" name="stock" type="text" class="form-control" value="98"></td>
					</tr>
					<tr class="submitTR">
